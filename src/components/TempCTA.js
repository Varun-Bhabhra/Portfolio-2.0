  ...
  return (
    ...
    >
      <img
        ...
        src={newcta_pc}
        alt="doodle"
        className={`fade-in cta_mockup hidden md:block md:w-6/12 drop-shadow-2xl object-cover transition-transform duration-500 ${
      ...
      <img
        ...
        src={newcta_phn}
        alt="doodle"
        className={`fade-in md:hidden w-5/6 sm:w-2/6 mx-auto drop-shadow-2xl ${
          myElementIsVisible ? "appear" : ""
        }`}
      />
