    ...
    <div id="showcase" className="py-20 text-secondary">
      ...
      >
        <article className="space-y-24 md:space-y-0 md:grid grid-cols-2">
          ...
          >
            <form
              action="https://formsubmit.co/bhabhravarun@gmail.com"
              method="POST"
            >
              <div className="flex flex-col gap-4">
                ...
                <input
                  ...
                  className="py-2 border-2 rounded-lg border-secondary focus:border-action focus:ring-0 bg-primary"
                  required
                />
                ...
                <input
                  ...
                  id="email"
                  name="email"
                  placeholder="mgscott@theoffice.com"
                  className="py-2 border-2 rounded-lg border-secondary focus:border-action focus:ring-0 bg-primary"
                  required
                />
                ...
                <textarea
                  ...
                  className="py-6 border-2 rounded-lg border-secondary focus:border-action focus:ring-0 bg-primary"
                  required
                ></textarea>
              </div>
              <button
                type="submit"
                className="mt-20 md:w-3/6 text-center text-primary bg-action border-2 border-action font-semibold py-3 w-full text-sm lg:text-lg rounded-lg cursor-pointer hover:scale105 hover:-translate-y1 hover:shadow-lg hover:shadow-action/30 hover:-translate-y-[2px] transition-all duration-200"
              >
                Send
              </button>
            </form>
