    ...
    <div id="showcase" className="pt-32 text-secondary">
      ...
      <section id="hero" className="max-w-screen-xl text-left sm:text-left mx-auto px-6 md:px-12 2xl:px-0 grid gap-10 sm:gap-0 justify-items-center items-center sm:grid-flow-col">
        ...
        <div className="space-y-2 lg:space-y-12 text-center sm:text-left md:mb-32">
          <h2 className="font-bold text-3xl md:text-4xl lg:text-5xl xl:text-7xl leading-snug">I design & develop amazing experiences.</h2>
          <p className="font-jost font-normal text-lg xl:text-xl xl:w-4/6">I'm Varun a developer & designer from Kolkata, India</p>
