      ...
      >
        <section className="space-y-8 md:space-y-0 md:grid sm:grid-cols-2 gap-12">
          ...
          <article className="flex flex-col md:flex-row">
            <article className="p-[1px] mb-12 md:mb-0 md:mr-4 bg-secondary rounded-full md:-translate-x-5 lg:-translate-x-7"></article>
            <div>
              <div
                id="header"
              ...
              >
                <p className="text-sm">
                  Hey👋, my name is Varun Bhabhra! I'm a self-taught developer &
                  designer from West Bengal, India, who is really into unique
                  designs, user experience and writing clean code.
                  <br />
                  <br />
                  Speaking of myself while studying B.com(Hons) in Accountancy
                  from University of Calcutta (Surprise!), web development
                  crossed my way and since then my journey as a developer begun.
                  Currently I'm working as a freelance developer, I've always
                  taken deep interest in designing and developing beautiful
                  websites for my clients which focus on providing the best
                  experience for everyone using them. Designing is something
                  that needs patience, effort and time. I am here to give in all
                  of it and make sure that my work becomes my identity. Being a
                  minimalist, my belief is to make things simple and very
                  specific. I'm open to learning and working my level best to
                  make the results near to perfect.
                  <br />
                  <br />
